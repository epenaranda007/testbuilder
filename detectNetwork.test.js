  ...
  for(var prefix = 38; prefix <= 39; prefix++){
    (function(prefix){
      it('has a prefix of '+prefix+' and a length of 14', function() {     
        if (detectNetwork(prefix+'345678901234') !== 'Diner\'s Club') {
...
describe('Maestro', function() {
  ...
  for(var prefix = '5018', num =  '12345678', length = 12; length <= 19; length++, num += '0'){
    (function(prefix,num,length){
      it('has a prefix of '+prefix+' and a length of '+length, function(){
        detectNetwork(prefix+num).should.equal('Maestro');
      });
    }(prefix,num,length));
  }
  ...
  for(var prefix = '5020', num =  '12345678', length = 12; length <= 19; length++, num += '0'){
    (function(prefix,num,length){
      it('has a prefix of '+prefix+' and a length of '+length, function(){
        detectNetwork(prefix+num).should.equal('Maestro');
      });
  ...
  for(var prefix = '5038', num =  '12345678', length = 12; length <= 19; length++, num += '0'){
    (function(prefix,num,length){
      it('has a prefix of '+prefix+' and a length of '+length, function(){
        detectNetwork(prefix+num).should.equal('Maestro');
      });
  ...
  for(var prefix = '6304', num =  '12345678', length = 12; length <= 19; length++, num += '0'){
    (function(prefix,num,length){
      it('has a prefix of '+prefix+' and a length of '+length, function(){
        detectNetwork(prefix+num).should.equal('Maestro');
      });
...
describe('China UnionPay', function(){
  ...
  for(var prefix = 624; prefix <= 626; prefix++){
    (function(prefix){
      ...
      it('has a prefix of '+ prefix +' and a length of 18', function(){
        detectNetwork(prefix + '12345678901245').should.equal('China UnionPay');
      });
      it('has a prefix of '+ prefix +' and a length of 19', function(){
